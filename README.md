...
| :--- | :--- | :--- |
| **Home Page** | ![Home](Images and Recording/home.png) | **Navigation Hub:** Features a custom UI for quick access to League, Team, and Player modules. |
| **League Trend** | ![League](Images and Recording/league.png) | [cite_start]**Macro Analysis:** Tracks season-wise scoring averages and the "East vs. West" dominance over 18 years[cite: 31, 35]. |
| **Team Analysis** | ![Team](Images and Recording/team.png) | [cite_start]**Performance Patterns:** Deep dive into "Home vs. Away" win percentages and team ranking fluctuations[cite: 33, 34]. |
| **Player Analysis** | ![Player](Images and Recording/player.png) | [cite_start]**Efficiency:** Analysis of individual scoring styles (Free Throws vs. 2PT vs. 3PT) and player impact metrics[cite: 32, 49]. |
